...
import com.company.project.shared.${className}DataFactory;
import com.company.project.shared.dao.${className}Dao;
import com.company.project.shared.model.${className};
import com.company.project.shared.model.${className};
import com.company.project.shared.service.impl.${className}ServiceImpl;
